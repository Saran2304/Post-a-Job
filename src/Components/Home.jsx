        ...
        <div>
            ...
            <div className="post">
                ...
                <div className='homepost'>
                    <p>Home</p>
                    <p className='postAjob'><span><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-envelope" viewBox="0 0 16 16">
                        <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1zm13 2.383-4.708 2.825L15 11.105zm-.034 6.876-5.64-3.471L8 9.583l-1.326-.795-5.64 3.47A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.741M1 11.105l4.708-2.897L1 5.383z" />
                    ...
                    <div className="row wholeform" >
                        ...
                        <div className="col-12 col-lg-6 col-md-6">
                            <div className="formright">
                                ...
                                <div className="job">
                                    <p>Budget/Salary*</p>
                                    <div class="input-group jobtitle2 flex-nowrap">
                                        <div className="row ms-0">
                                            <div class="form-check col-6 col-lg-4 fixed">
                                                <input onClick={fixed} class="form-check-input checkone" type="radio" name="flexRadioDefault" id="ratio1" />
                                                <label for="ratio1">
                                                    Fixed Salary
                                                </label>
                                            </div>

                                            <div class="form-check col-6 col-lg-4 range">
                                                <input onClick={range} class="form-check-input" type="radio" name="flexRadioDefault" id="ratio2" />
                                                <label for="ratio2">
                                                    Salary Range
                                                </label>
                                            </div>

                                            <div class="form-check col-6 col-lg-4 check">
                                                <input onClick={negotiate} class="form-check-input" type="radio" name="flexRadioDefault" id="ratio3" />
                                                <label for="ratio3">
                                                    Negotiable
                                                </label>
                                            </div>
                                        ...
                                        <div>
                                            {
                                                open === "fixed"
                                                    ?
                                                    <div class="input-group salary flex-nowrap">
                                                        <span class="input-group-text" id="addon-wrapping"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-coin" viewBox="0 0 16 16">
                                                    ...
                                                    open === 'range'
                                                        ...
                                                        <div className="row sr">
                                                            <div class="input-group col-6 minsalary flex-nowrap">
                                                                <span class="input-group-text" id="addon-wrapping"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" fill="currentColor" class="bi bi-coin" viewBox="0 0 16 16">
                                                                    <path d="M5.5 9.511c.076.954.83 1.697 2.182 1.785V12h.6v-.709c1.4-.098 2.218-.846 2.218-1.932 0-.987-.626-1.496-1.745-1.76l-.473-.112V5.57c.6.068.982.396 1.074.85h1.052c-.076-.919-.864-1.638-2.126-1.716V4h-.6v.719c-1.195.117-2.01.836-2.01 1.853 0 .9.606 1.472 1.613 1.707l.397.098v2.034c-.615-.093-1.022-.43-1.114-.9zm2.177-2.166c-.59-.137-.91-.416-.91-.836 0-.47.345-.822.915-.925v1.76h-.005zm.692 1.193c.717.166 1.048.435 1.048.91 0 .542-.412.914-1.135.982V8.518z" />
                                                                    <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14m0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16" />
                                                                    <path d="M8 13.5a5.5 5.5 0 1 1 0-11 5.5 5.5 0 0 1 0 11m0 .5A6 6 0 1 0 8 2a6 6 0 0 0 0 12" />
